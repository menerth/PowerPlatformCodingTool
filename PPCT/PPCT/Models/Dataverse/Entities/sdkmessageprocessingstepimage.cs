...
namespace PPCT.Models.Dataverse
{
	...
	public partial class SdkMessageProcessingStepImage : Microsoft.Xrm.Sdk.Entity
	{
		...
		public PPCT.Models.Dataverse.SdkMessageProcessingStep sdkmessageprocessingstepid_sdkmessageprocessingstepimage
		{
			get
			{
				return this.GetRelatedEntity<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null);
			}
			set
			{
				this.SetRelatedEntity<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null, value);
			}
		}
	}
}

...
namespace PPCT.Models.Dataverse
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageProcessingStep> sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PPCT.Models.Dataverse.SdkMessage sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntity<PPCT.Models.Dataverse.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntity<PPCT.Models.Dataverse.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
	}
}

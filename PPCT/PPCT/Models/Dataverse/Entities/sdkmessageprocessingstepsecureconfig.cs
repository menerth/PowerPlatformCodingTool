...
namespace PPCT.Models.Dataverse
{
	...
	public partial class SdkMessageProcessingStepSecureConfig : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageProcessingStep> sdkmessageprocessingstepsecureconfigid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageprocessingstepsecureconfigid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageprocessingstepsecureconfigid_sdkmessageprocessingstep", null, value);
			}
		}
	}
}

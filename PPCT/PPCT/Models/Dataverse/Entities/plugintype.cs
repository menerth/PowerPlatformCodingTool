...
namespace PPCT.Models.Dataverse
{
	...
	public partial class PluginType : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.CustomAPI> plugintype_customapi
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.CustomAPI>("plugintype_customapi", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.CustomAPI>("plugintype_customapi", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageProcessingStep> plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageProcessingStep> plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PPCT.Models.Dataverse.PluginAssembly pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntity<PPCT.Models.Dataverse.PluginAssembly>("pluginassembly_plugintype", null);
			}
			set
			{
				this.SetRelatedEntity<PPCT.Models.Dataverse.PluginAssembly>("pluginassembly_plugintype", null, value);
			}
		}
	}
}

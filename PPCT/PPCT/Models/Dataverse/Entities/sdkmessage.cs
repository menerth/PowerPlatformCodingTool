...
namespace PPCT.Models.Dataverse
{
	...
	public partial class SdkMessage : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessagePair> message_sdkmessagepair
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessagePair>("message_sdkmessagepair", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessagePair>("message_sdkmessagepair", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.CustomAPI> sdkmessage_customapi
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.CustomAPI>("sdkmessage_customapi", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.CustomAPI>("sdkmessage_customapi", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageFilter> sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PPCT.Models.Dataverse.SdkMessageProcessingStep> sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PPCT.Models.Dataverse.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null, value);
			}
		}
	}
}
